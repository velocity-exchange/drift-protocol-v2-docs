...
// mainnet-beta: EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v (USDC, unchanged from Drift)
```
  </TypeScript>
</SDKDoc>

On devnet, spot market index 0 is `dUSDT` (a placeholder quote token, 1e6 precision) rather than real USDC — mint it from the [token faucet](/developers/velocity-sdk/precision-and-types) or devnet tooling before depositing. On mainnet-beta the quote asset is still USDC at its original mint address.
