...
<Callout type="info">
Don't confuse an **Isolated Insurance Fund** (above) with [Isolated Pools](/protocol/how-it-works/isolated-pools) or [isolated positions](/protocol/trading/margin) — those confine collateral/margin to a single pool or position, while an Isolated Insurance Fund is a per-market backstop that's walled off from the standard Insurance Fund.
</Callout>
