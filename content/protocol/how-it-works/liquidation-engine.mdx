...
Even with all these protections, extreme events can still create negative balances. Velocity's **Insurance Fund** is the protocol's first backstop against this insolvency — it covers spot bankruptcies in full and perp bankruptcies up to a set per-market limit, with any remainder handled by socialized loss. See [Insurance Fund](/protocol/insurance-fund) for the coverage rules, funding sources, and the full perp-bankruptcy resolution waterfall.
