...
Non-USDT collateral carries a discount weighting; for example, SOL has an initial asset weight of 80% and a maintenance asset weight of 90%. Additionally, the initial asset weight can programmatically shrink based on total notional deposits.
