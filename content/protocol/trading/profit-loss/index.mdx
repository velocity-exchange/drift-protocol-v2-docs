...
This portion becomes **settled P&L**, which you can then withdraw to your USDT balance. Withdrawing your profits (settled P&L) depends on the P&L pool. If the pool has enough funds, your profits are available right away. If not, you might need to wait for others to settle their losses before you can withdraw your profits.
...
Settled P&L (a portion of realized P&L) becomes available for **withdrawal** from the [P&L pool](/protocol/how-it-works/profit-loss-pool) if the pool has enough funds. If not, you might need to wait for others to settle their losses before you can withdraw your profits.
</Steps>
